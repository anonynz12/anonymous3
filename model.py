...
class CacheGNN(nn.Module):
    ...
    def __init__(self,
        ...
        self.training_embedding_cache = None
        self.train_label_cache = None
    ...
    def get_training_embedding_cache(self,
                                     data,
        ...
        self.training_embedding_cache = train_info['train_embedding']
        self.train_label_cache = train_info['train_label']
